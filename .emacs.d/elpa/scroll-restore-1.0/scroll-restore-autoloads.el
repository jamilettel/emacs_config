...

;;;### (autoloads nil "scroll-restore" "scroll-restore.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "scroll-restore" '("scroll-restore-")))
